							...
							<div class="container">
								<div class="row">
									<div class="col-4 text-start py-3">
										...
										<!-- tombol input	 -->
										<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#myModal">[+] Data Produk</button>
										<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#tambahstok">[+] Stok</button>
									</div>
