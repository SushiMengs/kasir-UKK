					...
					<div class="row">
						<div class="col-sm-8">
							<form class="d-flex gap-2" method="POST" action="simpan.php">
								...
								?>
								<input class="form-control my-2 mx-2" type="number" placeholder="Jumlah" name="jp" value="1" style="width:100px">
								<button class="btn  btn-info my-2 mx-1" type="submit" name="save">Simpan</button>
							</form>
						</div>
						<div class="col-sm-4">
							<div class="d-grid">
								<a href="produk.php" class="btn  btn-success btn-block my-2 mx-1">Lihat Daftar Produk</a>
							</div>
						</div>
					</div>
				...
				<div class="table-responsive-sm">
					<table class="table table-hover table-striped table-sm ">
						<thead class="table-dark text-white">
							<tr>
								<th class="py-2 px-3" width="55px">No.</th>
								...
								<th class="py-2 text-center" width="130px">Aksi</th>
							</tr>
						</thead>
						<tbody>
							<?php
						...
						<form method="POST" action="simpan.php?halaman=<?= $halaman ?>">
							...
							<div class="modal-body modal-dialog-scrollable">
								<div class="row my-1 p-2">
									<iframe src="produk.php" height="30px"></iframe>
								</div>
							</div>
			...
			<div class="col-md-4">
				<div class="container border p-2 bg-secondary text-light rounded mb-2">
					<div class="row">
						...
						<div class="col-8">
							<h1 style="font-size:30px; text-align: right"><?= $jmltotal ?>,-</h1>
						</div>
					</div>
				</div>
				<?php
				...
				?>
					<div class="container border p-2 bg-info text-light rounded mb-2">
						<div class="row">
							...
							<div class="col-8">
								<h1 style="font-size:30px; text-align: right"><?= $byr ?>,-</h1>
							</div>
						</div>
					</div>
					<div class="container border p-2 bg-warning text-light rounded mb-2">
						<div class="row">
							...
							<div class="col-8">
								<h1 style="font-size:30px; text-align: right"><?= $kbl ?>,-</h1>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col">
							<div class="d-grid">
								<a href="selesai.php" class="btn  btn-info btn-block btn-lg">Selesai</a>
							</div>
						</div>
						<div class="col">
							<div class="d-grid">
