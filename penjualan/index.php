				...
				<table class="table table-hover table-striped table-sm">
					<thead class="table-dark text-white">
						<tr>
							...
							<th class="py-2 text-center" width="180px">Aksi</th>
						</tr>
					</thead>
					<tbody>
						<?php
						...
						?>
							<tr>
								...
								<td align="right">
									<a href="printnota.php?penid=<?= $data['penjualan_id'] ?>&kbl=<?= $kbl ?>" target="blank" class="btn  btn-primary btn-sm">Cetak Nota</a>
									<a href="detail_penjualan.php?penid=<?= $data['penjualan_id'] ?>&npet=<?= $dtpetugas['nama_petugas'] ?>&npel=<?= $dtpelanggan['nama_pelanggan'] ?>&tgl=<?= $data['tanggal'] ?>&byr=<?= $byr ?>&kbl=<?= $kbl ?>&halaman=<?= $halaman ?>" class="btn  btn-info btn-sm">Detail</a>
								...
								<div class="container">
									<div class="row">
										<div class="col-4 text-start py-3">
											...
											<a class="btn  btn-info" href="penjualan_simpan.php">Penjualan Baru</a>
										</div>
